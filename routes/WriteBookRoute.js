...
const { cacheChaptersofABook } = require("../middlewares/cacheBookMiddleware")
...
writeBookrouter.get("/getChapters/:bookId",isAuth,cacheChaptersofABook,getChaptersOfABook)
